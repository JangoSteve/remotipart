  ...
  module Generators
    class InstallGenerator < ::Rails::Generators::Base
      ...
      def install_iframe_transport
        ...
        copy_file "jquery.iframe-transport.js", "#{Remotipart::Rails::INSTALL_PATH}/jquery.iframe-transport.js"
      end

      def install_remotipart
        say_status "copying", "Remotipart.js #{Remotipart::Rails::VERSION}", :green
        copy_file 'jquery.remotipart.js', "#{Remotipart::Rails::INSTALL_PATH}/jquery.remotipart.js"
      end
    end
  end
end
